artifacts = {
    ...
    "io_bazel_rules_scala_scala_parser_combinators_2.13": {
    ...
    "org_scala_lang_modules_scala_collection_compat_2.13": {
    ...
    "org_scalameta_trees_2.13": {
        ...
        "deps": [
            "@com_thesamet_scalapb_scalapb_runtime_2.13",
            "@io_bazel_rules_scala_scala_library_2.13",
            "@org_scalameta_common_2.13",
            "@org_scalameta_fastparse_2.13",
        ],
    },
    "org_typelevel_paiges_core_2.13": {
    ...
    "com_thesamet_scalapb_lenses_2.13": {
    ...
    "com_thesamet_scalapb_scalapb_runtime_2.13": {
        ...
        "sha256": "10830d6511fc21b997c4acdde6f6700e87ee6791cbe6278f5acd7b352670a88f",
        "deps": [
            "@com_google_protobuf_protobuf_java_2.13",
            "@com_lihaoyi_fastparse_2.13",
            "@com_thesamet_scalapb_lenses_2.13",
            "@io_bazel_rules_scala_scala_library_2.13",
        ],
    },
    "com_lihaoyi_fansi_2.13": {
    ...
    "io_bazel_rules_scala_org_specs2_specs2_junit_2.13": {
    ...
    "scala_proto_rules_scalapb_plugin_2.13": {
    ...
    "scala_proto_rules_protoc_bridge_2.13": {
    ...
    "scala_proto_rules_scalapb_runtime_2.13": {
    ...
    "scala_proto_rules_scalapb_runtime_grpc_2.13": {
    ...
    "scala_proto_rules_opencensus_contrib_grpc_metrics_2.13": {
    ...
    "io_bazel_rules_scala_guava_2.13": {
    ...
    "com_google_guava_guava_21_0_2.13": {
        "testonly": True,
        "artifact": "com.google.guava:guava:21.0",
        "sha256": "972139718abc8a4893fa78cba8cf7b2c903f35c97aaf44fa3031b0669948b480",
        "deps": [
    ...
    "org_spire_math_kind_projector_2.13": {
        "testonly": True,
